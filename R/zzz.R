...
.First.lib<-function(libname,pkgname,where){
	...
	require(genefilter) || stop("can't load without genefilter")
	require(survival) || stop("can't load without survival")
	require(reposTools) || stop("can't load without reposTools")
    	if(missing(where)){
